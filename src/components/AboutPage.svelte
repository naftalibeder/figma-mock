...
<div>
  <div class="section pt-4">
    <div class="flex flex-col px-2 gap-2">
      <Type
        >Mock is developed by Naftali Beder and is completely free to use. The code is open source
        and available <a href="https://github.com/naftalibeder/figma-mock" target="_blank">
          here</a
        >.
      </Type>
      <Type
      ...
      >
      <Type
        >If you find Mock useful, consider clicking the heart icon on its <a
          href="https://www.figma.com/community/plugin/908371597321736295"
          target="_blank"
        >
          product page</a
